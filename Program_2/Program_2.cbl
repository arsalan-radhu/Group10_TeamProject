      ...
      *records onto 2 data files.
       ...
       file-control.
           ...
           assign to "../../../../Data/counts-and-control.out"
           organization is line sequential.
       ...
       01 counts-and-control-total-line
                                       pic x(102).
      ...
      *title for this team project.
       01 ws-heading1-name-line.
         ...
         05 filler                     pic x(13) value "Arsalan Radhu".
         05 filler                     pic x(46) value spaces.
         05 filler                     pic x(35) value
           "MAFD4202 - Team Project: Program #2".
      ...
      *both S or L records.
       01 ws-heading5-s-and-l-stores-totals-line-1.
         05 filler                     pic x(41) value
           "Total transaction amount for '01' stores:".
         05 filler                     pic x value spaces.
       ...
       01 ws-heading5-s-and-l-stores-totals-line-2.
         05 filler                     pic x(41) value
           "Total transaction amount for '02' stores:".
         05 filler                     pic x value spaces.
       ...
       01 ws-heading5-s-and-l-stores-totals-line-4.
         05 filler                     pic x(41) value
           "Total transaction amount for '04' stores:".
         05 filler                     pic x value spaces.
       ...
       01 ws-heading5-s-and-l-stores-totals-line-5.
         05 filler                     pic x(41) value
                   "Total transaction amount for '05' stores:".
         05 filler                     pic x value spaces.
       ...
       01 ws-heading5-s-and-l-stores-totals-line-6.
         05 filler                     pic x(41) value
           "Total transaction amount for '12' stores:".
         05 filler                     pic x value spaces.
      ...
      *each payment type that belong as an S, L or both S&L records.
       ...
       01 ws-heading6-s-and-l-payment-types-totals-line-2.
         05 filler                     pic x(35) value
           "% of transactions with Credit Card:".
         05 filler                     pic x value spaces.
       ...
       01 ws-heading6-s-and-l-payment-types-totals-line-3.
         05 filler                     pic x(34) value 
           "% of transactions with Debit Card:".
      ...
      *for 'R' records.
       01 ws-heading7-r-header-line.
         05 filler                     pic x(14) value "RETURN Records".
         05 filler                     pic x(88) value spaces.

      *Header that identifies all 'R' total records
      *and transaction amounts.
       01 ws-heading8-r-totals-line.
         ...
         05 filler                     pic x(35) value spaces.
         05 filler                     pic x(25) value 
           "'R' records total amount:".
         05 filler                     pic x value spaces.
         05 ws-total-r-amount          pic $$$,$$9.99.

      *This heading group will store and display the total
      *transaction for each valid stores which are 'R' records.
       ...
       01 ws-heading10-grand-total-line.
         05 filler                     pic x(19) value 
           "Grand Total Amount:".
         05 filler                     pic x value spaces.
         05 ws-total-grand             pic $$$,$$9.99 value spaces.
         05 filler                     pic x(72) value spaces.

      *Used to keep track of each transaction code record type.
       01 ws-counters.
         05 ws-sale-count              pic 99 value 0.
         05 ws-layaway-count           pic 99 value 0.
         05 ws-sale-and-layway-count   pic 99 value 0.
         05 ws-return-count            pic 99 value 0.
         05 ws-cash-count              pic 99 value 0.
         05 ws-credit-count            pic 99 value 0.
         05 ws-debit-count             pic 99 value 0.

       01 ws-calulcations.
      *    Might need to change all of the pic clauses here.
         05 ws-sale-total-amount       pic 9(7)v99 value 0.
         05 ws-layaway-total-amount    pic 9(7)v99 value 0.
         05 ws-s-and-l-total-amount    pic 9(7)v99 value 0.
         05 ws-return-total-amount     pic 9(7)v99 value 0.
         05 ws-s-and-l-store-01-total  pic 9(7)v99 value 0.
         05 ws-s-and-l-store-02-total  pic 9(7)v99 value 0.
         05 ws-s-and-l-store-03-total  pic 9(7)v99 value 0.
         05 ws-s-and-l-store-04-total  pic 9(7)v99 value 0.
         05 ws-s-and-l-store-05-total  pic 9(7)v99 value 0.
         05 ws-s-and-l-store-12-total  pic 9(7)v99 value 0.
         05 ws-r-store-01-total        pic 9(7)v99 value 0.
         05 ws-r-store-02-total        pic 9(7)v99 value 0.
         05 ws-r-store-03-total        pic 9(7)v99 value 0.
         05 ws-r-store-04-total        pic 9(7)v99 value 0.
         05 ws-r-store-05-total        pic 9(7)v99 value 0.
         05 ws-r-store-12-total        pic 9(7)v99 value 0.
         05 ws-pay-cash-total          pic 9(7)v99 value 0.
         05 ws-pay-credit-total        pic 9(7)v99 value 0.
         05 ws-pay-debit-total         pic 9(7)v99 value 0.
         05 ws-cash-percent            pic 99v99 value 0.
         05 ws-credit-percent          pic 99v99 value 0.
         05 ws-debit-percent           pic 99v99 value 0.
         05 ws-overall-amount          pic 9(7)v99 value 0.
         05 ws-grand-total-calc        pic 9(7)v99 value 0.
      ...
      *    amount to that.
           if il-store-01-88 then
               add il-transaction-amount
                                       to ws-r-store-01-total
               move ws-r-store-01-total
                                       to ws-total-r-01-store
           end-if.

           if il-store-02-88 then
               add il-transaction-amount
                                       to ws-r-store-02-total
               move ws-r-store-02-total
                                       to ws-total-r-02-store
           end-if.

           if il-store-03-88 then
               add il-transaction-amount
                                       to ws-r-store-03-total
               move ws-r-store-03-total
                                       to ws-total-r-03-store
           end-if.

           if il-store-04-88 then
               add il-transaction-amount
                                       to ws-r-store-04-total
               move ws-r-store-04-total
                                       to ws-total-r-04-store
           end-if.

           if il-store-05-88 then
               add il-transaction-amount
                                       to ws-r-store-05-total
               move ws-r-store-05-total
                                       to ws-total-r-05-store
           end-if.

           if il-store-12-88 then
               add il-transaction-amount
                                       to ws-r-store-12-total
               move ws-r-store-12-total
                                       to ws-total-r-12-store
           end-if.
